...
## Installation
### Automatic (Windows)
Download and execute [WaspFacer 0.97 installer](https://github.com/rciszek/WaspFacer/releases/download/v0.97/WaspFacerInstaller.exe/WaspFacerInstaller.exe).
